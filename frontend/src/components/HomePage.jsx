            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10 w-full">
              ...
              <div className="flex items-center justify-center">
                <div className="relative w-full max-w-md aspect-square">
                  ...
                  <img
                    src="https://images.unsplash.com/photo-1737644467636-6b0053476bb2"
                    alt="AI Robot"
                    className="relative w-full h-full object-contain drop-shadow-2xl transition-transform duration-200 ease-out"
                    style={{
                      transform: `translate(${robotPosition.x}px, ${robotPosition.y}px) scale(1.05)`,
                  ...
                  <div className="absolute bottom-1/3 right-1/4 w-2 h-2 bg-purple-400 rounded-full animate-ping" style={{ animationDelay: '0.5s' }}></div>
                  <div className="absolute top-1/2 right-1/3 w-2 h-2 bg-purple-600 rounded-full animate-ping" style={{ animationDelay: '1s' }}></div>
                </div>
              </div>
            </div>
          </div>
